...
// updated on 2024/11/17: lights are turned on by default
...
const YEARLY_TITLE = IS_CHINESE ? '年度' : 'Yearly';
const MONTHLY_TITLE = IS_CHINESE ? '月度' : 'Monthly';
const WEEKLY_TITLE = IS_CHINESE ? '周度' : 'Weekly';
